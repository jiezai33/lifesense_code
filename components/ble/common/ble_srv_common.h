...
/**************************************¡Á??¡§¨°?¡¤t??¨°??¡ã¨º?D?¦Ì?UUID start*********************************************************************/
#define BLE_UUID_WECHAT_SERVICE 								 0xFEE7			/**< Wechat service UUID. */
#define BLE_UUID_ANCS_SERVICE 									 0xFCC0			/*andriod  ancs UUID*/
#define BLE_UUID_TRANS_SERVICE 									 0xA500
#define BLE_UUID_OTA_SERVICE                                     0xA700


#define BLE_UUID_WECHRT_WRITE_CHAR								 0xFEC7			/**< Wechar write characteristic UUID. */
#define BLE_UUID_WECHRT_INDICATE_CHAR							 0xFEC8			/**< Wechar indicate characteristic UUID. */
#define BLE_UUID_WECHRT_READ_CHAR								 0xFEC9			/**< Wechar read characteristic UUID. */


#define BLE_UUID_ANCS_WRITE_CHAR								 0xFCC6			/**< Wechar write characteristic UUID. */
#define BLE_UUID_ANCS_INDICATE_CHAR								 0xFCC7			/**< Wechar indicate characteristic UUID. */
#define BLE_UUID_ANCS_READ_CHAR									 0xFCC8			/**< Wechar read characteristic UUID. */

#define BLE_UUID_TRANS_INDICATE_CHAR						     0xA501			/**< transfer indicate characteristic UUID. */
#define BLE_UUID_TRANS_WRITE_CHAR								 0xA502			/**< transfer write characteristic UUID. */
#define BLE_UUID_TRANS_NOTIFY_CHAR							     0xA503			/**< transfer indicate characteristic UUID. */

#define BLE_UUID_OTA_INDICATE_CHAR						         0xA701			/**< ota indicate characteristic UUID. */
#define BLE_UUID_OTA_WRITE_WIRSP_CHAR						     0xA702			/**< ota write with response characteristic UUID. */
#define BLE_UUID_OTA_WRITE_WORSP_CHAR							 0xA703			/**< ota write without response characteristic UUID. */
/**************************************¡Á??¡§¨°?¡¤t??¨°??¡ã¨º?D?¦Ì?UUID end*********************************************************************/
